...
type ContentType = 'text' | 'multimodal_text';
type PromptContent = {
    /**
...
declare class ChatGPTUnofficialProxyAPI {
     ...
     * @returns The response from ChatGPT
     */
    sendMessage(text: string, opts: SendMessageBrowserOptions, files: [
        {
            mimeType: string;
            width: number;
            height: number;
    ...
    getFileUploadUrl(uploadInfo: UploadInfo): Promise<any>;
    /**
     ...
     * @param file
     */
    upload(url: string, file: any): Promise<boolean>;
    /**
     * call after file uploaded
     * @param fileId
     */
    checkFileUploaded(fileId: string): Promise<boolean>;
    /**
     * upload file
     * @param filename
     * @param file
